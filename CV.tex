...
% ---------- HEADER ----------
\renewcommand{\title}[1]{%
{\LARGE\color{slateblue}\textbf{#1}}\\[2pt]
\rule{\textwidth}{0.5mm}\\
}
...
{\raggedleft\small Last updated: \today\par}
...
{\bf Mobile Phone} \> (+47) 41 21 75 72 \\
...
Inverse Problems, Mathematical Modeling, Wave Propagation, Seismic Imaging, Full Waveform Inversion, Numerical Analysis, Partial Differential Equations, Finite Element Method, Scientific Computing, High Performance Computing, Applications to realistic environments.
...
\textbf{Sep 2022 -- Aug 2024} \quad Postdoctoral position.  
...
\textbf{Sep 2021 -- Aug 2022} \quad Contractual assistant professor (``ATER'').  
\href{https://lmbp.uca.fr/}{Laboratory of Mathematics Blaise Pascal}, \href{http://polytech.univ-bpclermont.fr/}{Polytech Clermont INP}.  
...
\textbf{Sep 2025 -- 2027} \quad Department of Informatics, University of Oslo, Norway.  
...
\textbf{Sep 2021 -- Aug 2022} \quad Polytech Clermont INP.  
...
\textbf{2026--2027} \quad \href{https://www.mn.uio.no/ifi/studier/masteroppgaver/dsb/neural-operators-for-simulation-of-wave-propagatio.html}{Master's student project on neural operators for wave propagation}, with application to elastography.

\medskip

\textbf{Summer 2026} \quad Two summer interns working on software development for a unified finite element inversion framework for time-harmonic elastography.

% ---------- SKILLS ----------
\section{Skills}
\textbf{Languages:} French and Arabic (Native), English (Fluent), Norwegian (B1 - Intermediate), Spanish (Basic).
...
\begin{itemize}
\item \textbf{Aurora Grant (Research Council of Norway) 2026-- 2027:} FWI-Dams: Full-Waveform Inversion for Dam Safety. Mobility grant to establish and expand contact between French and Norwegian research organizations.  

\item \textbf{PHC Utique Project, 2020 \& 2022:} Visiting Researcher at the National School of Engineers of Tunis. Collaboration with LAMSIN laboratory on finite element algorithms with fading regularization for inverse problems.  
\end{itemize}
