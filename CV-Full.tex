...
Inverse Problems, Mathematical Modeling, Wave Propagation,  Seismic Imaging, Full Waveform Inversion,  Numerical Analysis, Partial Differential Equations,  Finite Element Method, Scientific Computing, High Performance Computing, 
...
\textbf{PhD examination committee} :\\
\textit{-M. Mejdi AZAIEZ, Full Professor, Institut Polytechnique de Bordeaux}\\
\textit{-M. Leonardo BAFFICO, Associate Professor, Université de Caen}\\
\textit{-Mme. Amel BEN ABDA, Full Professor, ENIT de Tunis}\\
\textit{-Mme. Laëtitia CAILLÉ, Associate Professor, Université de Poitiers}\\
\textit{-M. Fabien CAUBET, Associate Professor with Habilitation, Université de Pau et des Pays de l'Adour}\\
\textit{-Mme. Juliette LEBLOND, Senior Research Scientist, INRIA Centre de Recherche Sophia Antipolis}\\
\textit{-M. Liviu MARIN, Full Professor, Université de Bucarest}
}
...
{https://www.uio.no/dscience/english/dstrain/postdoctoral-fellows/aziz-boukraa.html}
{\href{https://www.mn.uio.no/ifi/english/}{Department of Informatics}, \href{https://www.uio.no/}{University of Oslo}, Norway}
{«\textbf{\textit{Inverse problems and image reconstruction in acoustics and elastography}}»}
{This position is part of the MSCA CO-FUND \href{https://www.uio.no/dscience/english/dstrain/postdoctoral-fellows/aziz-boukraa.html}{DSTrain} programme and is carried out in collaboration with the \href{https://www.mn.uio.no/ifi/english/research/groups/dsp/}{Digital Signal Processing group (DSB)} at the University of Oslo. The project develops physics-based inverse methods for imaging applications in acoustics and ultrasound shear-wave elastography.

\textbf{Secondment placement:} From May 2026, this project includes a three-month placement with \href{https://www.kongsberg.com/discovery/}{Kongsberg Discovery}, working with sonar data and full-waveform inversion for subseafloor imaging.
}
...
\job
{Sep 2025 -}{2027}
{\textbf{Department of Informatics, University of Oslo, Norway}}
{https://www.mn.uio.no/ifi/english/}
{Contractual assistant professor}
{
	\begin{itemize-noindent}
		\item{Lectures in ``Ultrasound Imaging'' course: Advanced Topics module.}
		\item{Lectures in ``Statistical Signal Processing'' course: Random processes and signal modeling modules.}
...
{
	\begin{itemize-noindent}
		\item{	\textbf{Tutorials for first-year engineering students (common core)}}
		\begin{itemize-noindent}
			\item{ General mathematics for first-year engineering students (3 groups$\times$18h): Matrix reduction, Jordan diagonalization, Solving differential systems, Laplace transformation,... }
    ...
    \item{ \textbf{Lectures and Tutorials, double degree course Architect-Engineer}}
		\begin{itemize-noindent}
\item{Third-year undergraduate level (1 group: 14h Lecture + 16h Tutorial): Matrix reduction, Jordan diagonalization, Reduction of quadratic forms, Conics, Solving differential systems, Double integrals,... }
\item{First-year undergraduate level (1 group: 14h Lecture + 16h Tutorial): Study of functions, Derivatives and primitives, Differential equations, Integral calculation,... }
		\end{itemize-noindent}	
\end{itemize-noindent}
}
...
\item{2019-2020: 1 group $\times$ 25h (Bachelor's common core in Mathematics and Mechanics)}
	\end{itemize-noindent}
\end{itemize-noindent}}
...
\job
{2026 -}{2027}
{\textbf{Master's student project}}
{https://www.mn.uio.no/ifi/studier/masteroppgaver/dsb/neural-operators-for-simulation-of-wave-propagatio.html}
{University of Oslo}
{Neural operators for wave propagation, with application to elastography.}

\job
{Summer}{2026}
{\textbf{Summer internship supervision}}
{https://www.uio.no/}
{University of Oslo}
{Supervision of two summer interns working on software development for a unified finite element inversion framework for time-harmonic elastography.}
...
\skillgroup{Aurora Grant (Research Council of Norway) - FWI-Dams: Full-Waveform Inversion for Dam Safety}
{
\textbf{Duration:} 2026--2027

\textbf{Description:} Mobility grant to establish and expand contact between French and Norwegian research organizations. The project supports international collaboration around full-waveform inversion methodologies for dam safety, building on previous work on seismic imaging of dam-rock interfaces.
}
...
% BEGIN JOURNALS
\begin{enumerate}
\item \textbf{Boukraa, M. A.}, Karabiyik, Y., Austeng, A., Holm, S., Näsholm, S. P.. Proof of concept for full-waveform inversion in ultrasound time-harmonic shear-wave elastography. \textit{Physics in Medicine \& Biology, 71(10), 105011, 2026}.: \href{https://doi.org/10.1088/1361-6560/ae6af4}{10.1088/1361-6560/ae6af4}
...
% BEGIN CONF TALKS
\begin{itemize}
\item 49th Scandinavian Symposium on Physical Acoustics (SSPA 2026), Geilo, Norway, January 2026. \url{https://www.norskfysisk.no/faggrupper/faggruppe-akustikk/sspa/}
...
\item 11th International Conference on Inverse Problems in Modeling and Simulations (IPMS 2024), Malta, May 2024. \url{https://www.ipms-conference.org/ipms2024/}
...
% BEGIN OTHER TALKS
\begin{itemize}
\item Improved full-waveform inversion strategies for ultrasound time-harmonic elastography, Oslo, Norway, dScience Lunch Seminar, March 2026. \url{https://www.uio.no/dscience/english/news-and-events/events/26-ls-mar5.html}
...
\begin{itemize}
  \item Peer reviewer for \textit{Computer Methods and Programs in Biomedicine}, Elsevier.
